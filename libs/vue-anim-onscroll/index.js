var ScrollAnimate = () => {
  ...
  return {
    isInView: ({ top: e, bottom: t }) =>
      e < (() => document.documentElement.clientHeight)() && t > 0,
    run(n, { value: i, modifiers: r }, { isUpwards: s, previousClassName: o = '' }) {
      if (!this.isInView(n.getBoundingClientRect())) return r.repeat && e(i) ? t(n, o) : void 0
      if (e(i)) return t(n, o, i)
      if (
        r.repeat ||
        ((e) => e.down && e.up)(i) ||
        !((e = '', t = '') => e.trim() !== t.trim())(n.className, o)
      ) {
        const e = s ? i.up : i.down
        return t(n, o, e)
      }
      return (({ params: e, isUpwards: t, repeat: n }) => n && ((t && e.down) || (!t && e.up)))({
        params: i,
        isUpwards: s,
        ...r
      })
